...
版本：1.1，2026-09-20，完整评审稿，已通过独立技术审阅，待用户业务审阅。1.1 增补工作通知的事项摘要与变更详情。依据：[9 月 19 日自检](../../dingtalk-self-check-2026-09-19.md)及用户提供的通用催确认通知截图。本次只交付设计，未修改生产代码、数据、外发规则，也未实施新功能。
...
工作通知正文直接展示事项名称、本人相关要求、真实期限和需要采取的动作；变更通知列出获准展示的原值与新值，多事项提供具体条目和完整详情入口。成员不必先打开网页才知道是哪件事。现有工作通知先实现内容增强，后续原生卡片复用同一规范。
...
| 包 | 文档 | 交付范围 |
| --- | --- | --- |
| P0 基础修复与运行保障 | [P0 设计](2026-09-19-dingtalk-foundation-design.md) | 事项摘要与变更详情、确认提醒、草稿误发、钉钉入口、身份一致性、投递停机与诊断、备份 |
...
三个包共用[通知内容设计](2026-09-20-dingtalk-notification-content-design.md)：P0 改进已有模板，P1 为新业务事件补内容，P2 复用接收人权限投影；该增补不构成第四套消息服务。
...
| 用户场景 | 目标行为 | 阶段 |
| --- | --- | --- |
| 通知只有通用提醒，看不出具体工作 | 正文展示事项摘要、真实期限、变化与明确动作；多项按本人可见范围汇总 | P0，并延续至 P1/P2 |
...
- 通知正文能辨认具体事项、已有要求及相关期限；变更可读、多事项可展开、内容按接收人裁剪；旧消息和模板升级不触发历史重发。
