...
- [x] Commit application, build exact Linux image, run tests, backup then deploy to 192.168.0.37:4310. Verify health, data checksum preservation and source UI assets. Record actual evidence in validation docs.
...
Deployment completed 2026-09-14 15:27 Shanghai, application b168c8e. Evidence: docs/weekly-assignment-2026-09-14.md. All original entity hashes preserved.
