// Frozen from git show 65317c6:server/work-progress.ts; import paths only adapted.
...
import { isActiveWeeklyRecord, isEffectiveWeeklyRecord } from './weekly-record-state.ts'
import { HttpError, type Store } from '../../../server/store.ts'
import { assertBusinessActor } from './object-access.ts'
import { meaningfulText } from './helpers.ts'
